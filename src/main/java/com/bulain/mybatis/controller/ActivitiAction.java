...
public class ActivitiAction extends DefaultActionSupport{
	...
	public String view(){
		...
		listHistoryActivityInstance = historyService.createHistoricActivityInstanceQuery().executionId(executionId).list();
	...
	public void setListHistoryActivityInstance(
			List<HistoricActivityInstance> listHistoryActivityInstance) {
	...
	public void setListHistoryProcessInstance(
			List<HistoricProcessInstance> listHistoryProcessInstance) {
