...
<html>
<head>
    <title><s:text name="account.model"/><s:text name="title.list"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="account.model"/><s:text name="title.list"/></td>
    </tr>
</table>
<br/>

<s:form action="list" method="post" id="search" namespace="/account" theme="simple">
    <table class="page-form" cellspacing="0" width="100%">
        <tr>
        ...
        <tr>
            ...
            <td class="page-form-value"><s:select name="search.type" list="listReferanceCashAccountType" listKey="key" listValue="value" value="search.type" /></td>
        </tr>
        <tr>
            <td width="20%"></td>
            <td width="30%"></td>
        ...
        <tr>
            <td colspan="4">
                <table cellspacing="0" width="100%">
                    <tr>
                        <td width="40%"><s:url id="url" action="new" /><a id="lnk_new" href="<s:property value="#url"/>"><s:text name="action.new"/><s:text name="account.model"/></a></td>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    <tr class="list-table-header">
    	<th width="10%"><page:order fixOrderBy="name"><s:text name="account.name"/></page:order></th>
    	<th width="10%"><page:order fixOrderBy="type"><s:text name="account.type"/></page:order></th>
