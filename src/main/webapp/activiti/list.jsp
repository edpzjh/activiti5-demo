...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    ...
    <s:iterator value="listProcessDefinition" status="status">
        <tr class="<s:if test="#status.even">list-line-even</s:if><s:else>list-line-odd</s:else>" >
            ...
            <td class="noWrap"><s:property value="category"/></td>
            <td class="noWrap"><s:property value="name"/></td>
            <td class="noWrap"><s:property value="key"/></td>
            <td class="noWrap"><s:property value="version"/></td>
            <td class="noWrap"><s:property value="resourceName"/></td>
            <td class="noWrap"><s:property value="deploymentId"/></td>
            <td class="noWrap"><s:property value="diagramResourceName"/></td>
            <td class="noWrap"><s:property value="startFormKey"/></td>
            <td class="minNoWrap">
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    ...
    <s:iterator value="listProcessInstance" status="status">
        <tr class="<s:if test="#status.even">list-line-even</s:if><s:else>list-line-odd</s:else>" >
            ...
            <td class="noWrap"><s:property value="businessKey"/></td>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    ...
    <s:iterator value="listPersonTask" status="status">
        <tr class="<s:if test="#status.even">list-line-even</s:if><s:else>list-line-odd</s:else>" >
            ...
            <td class="noWrap"><s:property value="taskDefinitionKey"/></td>
            <td class="minNoWrap">
        	<s:url id="url" action="active"><s:param name="taskId" value="id"></s:param></s:url><a href="<s:property value="#url"/>">Active</a>
        	</td>
        </tr>
    </s:iterator>
</table>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    ...
    <s:iterator value="listHistoryProcessInstance" status="status">
        <tr class="<s:if test="#status.even">list-line-even</s:if><s:else>list-line-odd</s:else>" >
            ...
            <td class="noWrap"><s:property value="endActivityId"/></td>
            <td class="noWrap"><s:property value="startUserId"/></td>
            <td class="noWrap"><s:property value="startActivityId"/></td>
            <td class="minNoWrap">
