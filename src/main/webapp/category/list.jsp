...
<html>
<head>
    <title><s:text name="category.model"/><s:text name="title.list"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="category.model"/><s:text name="title.list"/></td>
    </tr>
</table>
<br/>

<s:form action="list" method="post" id="search" namespace="/category" theme="simple">
    <table class="page-form" cellspacing="0" width="100%">
        <tr>
