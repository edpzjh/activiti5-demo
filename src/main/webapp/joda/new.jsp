...
<html>
<head>
    <title><s:text name="joda.model"/><s:text name="title.add"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="joda.model"/><s:text name="title.add"/></td>
    </tr>
</table>
<br/>
...
$(document).ready(function() {
	$("#create").validate();
	$("#create_joda_xdate").datepicker({dateFormat:'<s:text name="fmt.jq.date"/>'});
